...
<!-- 			<navigator class="mt20" hover-class="none" url="/pages/bundle/server_explan/server_explan?type=2">
			...
			<view class="footer row bg-white fixed">
				...
				<navigator class="btn cart column-center" hover-class="none" open-type="switchTab"
					url="/pages/shop_cart/shop_cart" v-if="goodsDetail.first_category_id == 1">
				...
				<view v-if="btnText.yellow && goodsDetail.first_category_id == 1" class="add-cart br60 white mr10 md ml20" @tap="showSpecFun(1)">
					{{ btnText.yellow }}</view>
		...
		<float-tab :show-cart="goodsDetail.first_category_id == 1"></float-tab>
		<!-- 领券 -->
	...
	export default {
		...
		methods: {
			...
			onBuy(e) {
				...
				params.payWayType = this.goodsDetail.first_category_id
				uni.navigateTo({

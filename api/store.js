...
//补贴积分提现
export function butieTixian(data) {
	return request.post("jk/ticket_points", data);
}

//文票折线图
export function zhexian(data) {
	return request.post("jk/get_price", data);
}

//折线图参数
export function zhexiantucanshu(data) {
	return request.post("jk/get_price_parameter", data);
}

//文票兑换
export function wenpiaoExchange(data) {
	return request.post("jk/ticket_exchange", data);
}

// 提现
export function wenpiaoWithdraw(data) {
	return request.post("jk/ticket_ticket", data);
}

//文票提现记录
export function wenpiaoWithdrawRecord(data) {
	return request.post("jk/ticket_ticket_list", data);
}

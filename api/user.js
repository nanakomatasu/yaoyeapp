...
//获取我的团队参数
export function getMyteamCanshu(data) {
    return request.post("jk/my_team_parameters", data)
}

//获取我的团队
export function getMyteam(data) {
    return request.post("jk/my_team", data)
}

//获取消息滚动条
export function gundongNotify(data) {
    return request.post("jk/get_message_list", data)
}
